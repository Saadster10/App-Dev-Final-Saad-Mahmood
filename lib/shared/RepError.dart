...
class RepError extends StatefulWidget {
  const RepError({Key? key}) : super(key: key);

  @override
  _RepErrorState createState() => _RepErrorState();
}

class _RepErrorState extends State<RepError> {
  final ErrorPost _err = ErrorPost();
  final _formKey = GlobalKey<FormState>();
  bool loading = false;

  // Variable for data
  late String errdescript;
  String error = '';
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            validator: (value) => value!.isEmpty
                                ? 'Error\'s Description required'
                                : null,
                            onChanged: (value) {
                              setState(() => errdescript = value);
                            },
                            decoration: textInputDecoration.copyWith(
                              labelText: 'Describe Error',
                            ...
                            child: RaisedButton(
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  await _err.posterror(uploadURL!, errdescript,
                                      username, useruid);
